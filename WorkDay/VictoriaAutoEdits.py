...
# line = re.sub('\b(y)(?=[^ts])[a-z]{1}\b', "wi", line, flags = re.IGNORECASE) #wyse to wise
        ...
        line = re.sub(r'^the\b\s+\w+$', "", line, flags = re.IGNORECASE)
        line = re.sub('fadyr', "fader", line, flags = re.IGNORECASE)
        line = re.sub(r'(?!Amen)^[\w\.]+$', "", line, flags = re.IGNORECASE) #Remove speaker tags
        line = re.sub(r'\bwit\b', "wyt", line, flags = re.IGNORECASE )
...
#  line = re.sub('[ē]',"em", line, flags = re.IGNORECASE)
        ...
        line = re.sub('[ū]',"un", line, flags = re.IGNORECASE)
        ...
        line = re.sub('commith', "commyth", line, flags = re.IGNORECASE)
        line = re.sub('cōmen', "commen", line, flags = re.IGNORECASE)
        line = re.sub('cōmoditees', "commoditees", line, flags = re.IGNORECASE)
        line = re.sub('cōmodytees', "commoditees", line, flags = re.IGNORECASE)
